...
class KNet(UNet):
    ...
    def __init__(self, convBlock=ConvBlock, num_layers=4, base_filters=64, kan_type="RBF", num_grids=4):
        super(KNet, self).__init__(convBlock=convBlock, num_layers=num_layers, base_filters=base_filters)
